...
var List = function () {
  ...
  this.generateRandomFixedSize = function (vertexText) {
    if (activeStatus == "stack") {
      if (vertexText > maxStackSize) {
        $("#create-err").html(
          "maximum allowed number of vertex is " + maxStackSize
        );
        return false;
      }
    } else {
  ...
  this.search = function (vertexText) {
    ...
    while (currentVertex != null) {
      ...
      if (parseInt(vertexText) != parseInt(currentVertex)) {
        ...
        currentState["vl"][currentVertexClass]["state"] = VERTEX_HIGHLIGHTED;
        currentState["status"] =
          currentVertex + " is not equal to " + vertexText;
        currentState["lineNo"] = 2;
        stateList.push(currentState);
        //end
        ...
        if (currentVertex == null) {
          ...
          currentState["status"] =
            "Vertex " + vertexText + " is not in the Linked List";
    ...
    if (currentVertex != null) {
      ...
      currentState["vl"][currentVertexClass]["state"] = VERTEX_HIGHLIGHTED;
      currentState["status"] =
        "Found vertex " + vertexText + " return" + " (index = " + index + ")";
  ...
  this.insertArrKth = function (vertexTextArr, index) {
    ...
    for (j = 0; j < index - 1; j++) {
      ...
      vertexTraversed[currentVertex] = true;
      currentState["status"] =
        "decrement k, index specified has not been reached, " +
        "(k = " +
        (index - 1 - j) +
        ")";
      currentState["lineNo"] = 2;
    ...
    newVertexVertexClass =
      internalList[parseInt(vertexText)]["vertexClassNumber"];
    var tempChild;
    ...
    currentState["vl"][tempVertexClass]["state"] = VERTEX_GREEN_FILL;
    currentState["status"] =
      "Re-layout the linked list. " + vertexText + " has been inserted!";
    currentState["lineNo"] = 0;
  ...
  this.insertArrKthDoublyList = function (vertexTextArr, index) {
    ...
    currentState["el"][currentVertexClass]["state"] = EDGE_TRAVERSED;
    currentState["el"][newVertexVertexClass]["state"] = EDGE_RED;
    currentState["el"][newVertexVertexClass + BACK_EDGE_CONST][
      "state"
    ] = OBJ_HIDDEN;
    currentState["status"] = "newVertex.next points to temp2";
    currentState["lineNo"] = 6;
    ...
    currentState["el"][currentVertexClass + BACK_EDGE_CONST][
      "state"
    ] = OBJ_HIDDEN;
  ...
  this.insertArrTail = function (vertexTextArr) {
    ...
    currentState["el"][currentVertexClass]["animateHighlighted"] = true;
    currentState["status"] =
      "tail.next points to new vertex. Inserting " + vertexText + " ...";
    currentState["lineNo"] = 2;
    stateList.push(currentState);
    //end
    ...
    currentState["vl"][newVertexVertexClass]["state"] = VERTEX_BLUE_FILL;
    currentState["status"] =
      "Update tail pointer. " + vertexText + " has been inserted!";
    currentState["lineNo"] = 3;
    stateList.push(currentState);
    // End State
    ...
    currentState = createState(internalList);
    currentState["status"] =
      "Insert " + vertexText + " to tail has been completed.";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.removeArrHead = function () {
    ...
    if (internalList[currentVertex]["rightChild"] == null) {
      ...
      rightChildVertexClass =
        internalList[rightChildVertex]["vertexClassNumber"];
  ...
  this.removeArrKth = function (vertexTextArr) {
    ...
    if (internalList[currentVertex]["rightChild"] == null) {
      ...
      rightChildVertexClass =
        internalList[rightChildVertex]["vertexClassNumber"];
      internalList[currentVertex]["cy"] =
        50 + internalList[currentVertex]["cy"];
  ...
  this.removeArrKthDoublyList = function (vertexTextArr) {
    ...
    if (internalList[currentVertex]["rightChild"] == null) {
      ...
      currentState["el"][parentVertexClass + BACK_EDGE_CONST][
        "state"
      ] = OBJ_HIDDEN;
      currentState["vl"][rightChildVertexClass]["state"] = VERTEX_RED_FILL;
      currentState["status"] = "Delete vertex";
  ...
  function init(initArr) {
    ...
    for (key in internalList) {
      ...
      graphWidget.addVertex(
        ...
        internalList[key]["cy"],
        key,
        internalList[key]["vertexClassNumber"],
        true
      );
    }
    ...
    for (key in internalList) {
      ...
      graphWidget.addEdge(
        internalList[parentVertex]["vertexClassNumber"],
        internalList[key]["vertexClassNumber"],
        internalList[parentVertex]["vertexClassNumber"],
        EDGE_TYPE_DE,
        1,
      ...
      if (activeStatus == "doublylist" || activeStatus == "deque") {
        graphWidget.addEdge(
          internalList[key]["vertexClassNumber"],
          internalList[parentVertex]["vertexClassNumber"],
          internalList[parentVertex]["vertexClassNumber"] + BACK_EDGE_CONST,
          EDGE_TYPE_DE,
          1,
          true
        );
  ...
  function clearScreen() {
    ...
    for (key in internalList) {
      if (key == "root") continue;
      graphWidget.removeEdge(
        internalList[key]["vertexClassNumber"] + BACK_EDGE_CONST
      );
  ...
  function createState(internalListObject, vertexTraversed, edgeTraversed) {
    ...
    for (key in internalListObject) {
      ...
      state["el"][parentChildEdgeId]["vertexA"] =
        internalListObject[key]["vertexClassNumber"];
      state["el"][parentChildEdgeId]["vertexB"] =
        internalListObject[internalListObject[key]["rightChild"]][
          "vertexClassNumber"
        ];
      ...
      if (activeStatus == "doublylist" || activeStatus == "deque") {
        parentChildEdgeId =
          internalListObject[key]["vertexClassNumber"] + BACK_EDGE_CONST;
        state["el"][parentChildEdgeId] = {};
    ...
    function updatePosition(currentVertex) {
      ...
      if (activeStatus == "stack") {
        if (currentVertex == internalList["root"])
          ...
          var parentVertex = internalList[currentVertex]["parent"];
          internalList[currentVertex]["cy"] =
            internalList[parentVertex]["cy"] + 70;
        }
      ...
      //relayout horizontal
        ...
        if (currentVertex == internalList["root"])
          ...
          var parentVertex = internalList[currentVertex]["parent"];
          internalList[currentVertex]["cx"] =
            internalList[parentVertex]["cx"] + 70;
        }
