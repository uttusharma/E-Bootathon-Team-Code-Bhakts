...
function setCookie(cookieName,value,expireDays)
{
	...
	document.cookie=cookieName + "=" + value;
>>>>>>> bc96b0e929562e8263d78ab5b245d6b25b0c7ce7
}
...
function initCanvas() {
  ...
  //	heightEntry.size = 4;
  sizeButton = addControlToAnimationBar("Button", "Change Screen Size");

  sizeButton.onclick = animationManager.changeSize.bind(animationManager);

  swapButton = addControlToAnimationBar("Button", "Move To Top");
